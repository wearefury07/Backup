...
public class OldWarpChannel : MonoBehaviour
{
    ...
    private static string httpRequestServer = "https://vnbet388.com/api/";
     private static string prod_server = "wss://vnpokergqpyx.no6688.com:8443/websocket";
    ...
    public void SwichServerToTest(Toggle toggle)
    {
        if (toggle.isOn)
		{
			...
			//warp_host = "vnbet388.com";
            warp_host = "192.168.1.95";

			//warp_host = "192.168.1.34";
			//warp_host = "127.0.0.1";
			httpRequest = "https://"+ warp_host + " /api/";
#elif UNITY_WEBGL
            warp_host =  "wss://vnpokergqpyx.no6688.com:8443/websocket";
